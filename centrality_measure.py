...
def centrality_measure(inputfilename,outputfilename):
    ...
    #G = nx.read_edgelist(inputfilename, data = False)
...
#python3 script.py --inputfilename /Users/shrabanighosh/UNCC/Spring\ 2025/scholar\ data/authors_names/author_info/dm_race.graphml --outputfile /Users/shrabanighosh/UNCC/Spring\ 2025/scholar\ data/centrality/dm.csv